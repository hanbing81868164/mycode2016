...
namespace System
{
    ...
    public class VerifyImage : IVerifyImage
	{
        ...
        public VerifyImageInfo GenerateImage(string code, int width, int height, Color bgcolor, int textcolor, string type)
        {
            code = addcode(code, type);
        ...
        /// </summary>
        /// <returns></returns>
        private string addcode(string code, string type)
        {
            string checkCode = code == null ? CreateRandomCode(4, type) : code;

            HttpContext.Current.Session["CheckCode"] = checkCode;
            HttpContext.Current.Session.Timeout = 60;
            return checkCode;
        }
        private string CreateRandomCode(int codeCount, string type)
        {
            //////////////////////
            int number;
            char code;

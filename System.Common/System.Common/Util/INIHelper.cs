...
namespace System
{
    ...
    public class INIHelper
    {
        ...
        /// <summary>
        /// 得到指定section下的所有key,value数组
        /// </summary>
        /// <param name="section"></param>
        /// <param name="path"></param>
        /// <returns></returns>
        public static Dictionary<string, string> GetKeyValues(string section, string path)
        {
            Dictionary<string, string> res = new Dictionary<string, string>();
            string[] keys = { }, values = { };
            GetAllKeyValues(section, out keys, out values, path);
